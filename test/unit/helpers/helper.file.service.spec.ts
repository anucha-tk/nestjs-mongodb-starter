...
describe("HelperFileService", () => {
  ...
  describe("createJson", () => {
    it("should return true and create json file base on path", () => {
      const result = service.createJson("data/__simple.json", []);
  ...
  describe("readJson", () => {
    it("should return object of json", () => {
      service.createJson("data/__simple.json", []);
      const result = service.readJson("data/__simple.json");
